...
class Admin_Form
{
    ...
    public function load_view_general()
    {
        ...
        $short_description_homepage = get_option('short_description_homepage');
        ...
        if ($short_description_homepage) {
            echo '<input class="form-control" value="' . $short_description_homepage . '" id="h1-home-page">';
        } else {
            echo '<input class="form-control" id="h1-home-page">';
        }
